 ...
 * Total byte count requested : FIFO_WATERMARK_FRAME_COUNT * BMP3_LEN_P_OR_T_HEADER_DATA
 */
...
int main(void)
{
    ...
    settings_fifo = BMP3_SEL_FIFO_MODE | BMP3_SEL_FIFO_TEMP_EN | BMP3_SEL_FIFO_FWTM_EN | BMP3_SEL_FIFO_DOWN_SAMPLING |
    ...
    printf("Read Fifo watermark interrupt data\n");
